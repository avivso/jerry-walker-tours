...
(() => {
  ...
  const I18N = {
    he: {
      ...
      "choice.line": "הבחירה קשה ולא בטוחים איזה סיור לסגור? בדיוק בשביל זה אני כאן. דברו איתי, ואתאים לכם את הסיור המושלם עבורכם!",
    ...
    en: {
      ...
      "choice.line": "Hard to choose, not sure which tour to book? That's exactly what I'm here for. Talk to me, and I'll tailor the perfect tour for you!",

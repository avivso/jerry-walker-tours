...
(() => {
  ...
  const I18N = {
    he: {
      ...
      "hero.sub": "סיורים פרטיים מודרכים בעברית — היסטוריה, אמנות וסיפורים, באווירה אישית ומשעשעת.",
      ...
      "about.p2": "אני מדריך סיורים פרטיים בלבד, לקבוצות של 1 עד 12 מטיילים. איני מארגן קבוצות זרות — הסיור הוא שלכם, בקצב שלכם.",
      ...
      "contact.cardText": "המחירים נקבעים לפי הסיור והרכב המטיילים. הדרך המהירה לקבל הצעה — הודעת וואטסאפ. אני בדרך כלל זמין ועונה מהר.",
      "contact.fine": "סיורים פרטיים בלבד · 1–12 מטיילים · ללא קבוצות",
    ...
    en: {
      ...
      "hero.sub": "Private guided tours in Hebrew & English — history, art and stories, with a personal, witty touch.",
      ...
      "contact.sub": "Reach me on WhatsApp, by phone, email or Facebook/Instagram — I'll get back to you with all the details and pricing, and together we'll shape the perfect tour for you.",
      ...
      "contact.fine": "Private tours only · 1–12 travellers · no groups",
  ...
  /* ---------- value props ---------- */
  const VALUES = [
    { ico: "M12 2 4 5v6c0 5 3.4 8.7 8 10 4.6-1.3 8-5 8-10V5l-8-3zm0 4.3 1.7 3.5 3.8.5-2.8 2.7.7 3.8L12 19l-3.4 1.8.7-3.8-2.8-2.7 3.8-.5L12 6.3z",
      he: { t: "סיורים פרטיים בלבד", d: "1–12 מטיילים — בלי קבוצות זרות" },
      en: { t: "Private tours only", d: "1–12 travellers — never a mixed group" } },
    ...
    { ico: "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm6.9 9h-3a15.9 15.9 0 0 0-1.3-5.7A8 8 0 0 1 18.9 11zM12 4c.9 1.3 1.7 3.4 1.9 7h-3.8c.2-3.6 1-5.7 1.9-7zM4.3 13h3a15.9 15.9 0 0 0 1.3 5.7A8 8 0 0 1 4.3 13zm3-2h-3a8 8 0 0 1 4.3-5.7A15.9 15.9 0 0 0 7.3 11zM12 20c-.9-1.3-1.7-3.4-1.9-7h3.8c-.2 3.6-1 5.7-1.9 7zm2.6-1.3A15.9 15.9 0 0 0 15.9 13h3a8 8 0 0 1-4.3 5.7z",
      he: { t: "בעברית (וגם באנגלית)", d: "הדרכה צמודה בשפה שלכם" },
      en: { t: "In Hebrew (and English)", d: "Personal guiding in your language" } },
    { ico: "M12 1 3 5v6c0 5.6 3.8 10.7 9 12 5.2-1.3 9-6.4 9-12V5l-9-4zm-1.2 14.2L7.3 11.7l1.4-1.4 2.1 2.1 4.5-4.5 1.4 1.4-5.9 5.9z",
      he: { t: "גמיש ומותאם אישית", d: "הקצב והדגשים — לפיכם" },
  ...
  const TOURS = [
    ...
    },
    {
      ...
      en: { dur: "≈ 3 hours", title: "Heart of the City — 7th & 8th",
    ...
    },
    {
      ...
      he: { dur: "כ-3 שעות", title: "בית הקברות פר לשז — היחיד בעברית",
        short: "הסיור היחיד בעברית בבית הקברות האיקוני. סיפורים מפתיעים, מצבות מעוצבות ונופים מהממים. אולי הסיור הטוב שלי.",
        long: "סיור מרתק, מקורי ויחודי — מוכר מאוד לדוברי האנגלית, וכעת נגיש גם לדוברי העברית. בין המצבות המעוצבות והנופים המהממים נשמע סיפורים שלא תשכחו. אולי הסיור הטוב ביותר שלי.",
      ...
      en: { dur: "≈ 3 hours", title: "Père-Lachaise Cemetery",
        short: "The only Hebrew tour of this iconic cemetery — surprising tales, sculpted graves and stunning scenery. Perhaps my very best tour.",
        long: "A fascinating, original and unique tour — hugely popular in English, and now available in Hebrew. Among the sculpted graves and stunning scenery we'll hear stories you won't forget. Perhaps my very best tour.",
    ...
    {
      img: "tour-louvre.jpg",
      he: { dur: "שעתיים / 3 / 4–5 שעות", title: "סיור מודרך בעברית במוזיאון הלובר",
    ...
    },
    {
      ...
      en: { dur: "≈ 3 hours", title: "Paris: City of Lights & Shadows",
        ...
        long: "A fascinating, original walking tour following espionage and security affairs that unfolded on the streets of Paris. True spy stories, mystery and shadows — that you won't hear on any other tour.",
    ...
    },
    {
      ...
      he: { dur: "כ-3 שעות", title: "הרובע היהודי — לה מארה",
        short: "צלילה אל הזהות והזיכרון ברובע המארה ההיסטורי — סיפורם של אבירי הטמפלרים ושל יהדות פריז. וכן — פלאפל חם כלול!",
  ...
  const TRIPS = [
    ...
    { img: null, size: "lg", icon: ICON_CASTLE,
    ...
    { img: null, size: "sm", icon: ICON_STAR,
    ...
    { img: null, size: "sm", icon: ICON_PALETTE,
    ...
    { img: null, size: "sm", icon: ICON_FLOWER,
